...
# base container
docker build --build-arg ST2_VERSION="2.0.0-1" --build-arg ST2_REPO="staging-stable" -t st2 stackstorm/
# st2web container
docker build --build-arg ST2_VERSION="2.0.0-1" --build-arg ST2_REPO="staging-stable" -t stackstorm/st2web st2web/
